...
#if !defined(_UL)
#define _Ul(x)          x ## U            /**< C code: Unsigned integer literal constant value */
#define _Sl(x)          x ## L            /**< C code: Long integer literal constant value */
#define _UL(x)         x ## UL           /**< C code: Unsigned Long integer literal constant value */
#endif
#else
#if !defined(_UL)
#define _Ul(x)          x                 /**< Assembler: Unsigned integer literal constant value */
#define _Sl(x)          x                 /**< Assembler: Long integer literal constant value */
...
#define HSRAM_SIZE            _UL(0x00030000) /* 192 kB */
...
#define DSU_DID_RESETVALUE    _UL(0x60060005)
