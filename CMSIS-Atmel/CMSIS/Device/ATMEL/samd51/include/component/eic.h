...
#define EIC_CTRLA_RESETVALUE        _U(0x00)     /**< \brief (EIC_CTRLA reset_value) Control A */
...
#define EIC_NMIFLAG_RESETVALUE      _U(0x0000)   /**< \brief (EIC_NMIFLAG reset_value) Non-Maskable Interrupt Flag Status and Clear */
...
#define EIC_SYNCBUSY_RESETVALUE     _U(0x00000000) /**< \brief (EIC_SYNCBUSY reset_value) Synchronization Busy */
...
#define EIC_ASYNCH_RESETVALUE       _U(0x00000000) /**< \brief (EIC_ASYNCH reset_value) External Interrupt Asynchronous Mode */
...
#define EIC_CONFIG_RESETVALUE       _U(0x00000000) /**< \brief (EIC_CONFIG reset_value) External Interrupt Sense Configuration */
...
#define EIC_DEBOUNCEN_RESETVALUE    _U(0x00000000) /**< \brief (EIC_DEBOUNCEN reset_value) Debouncer Enable */

#define EIC_DEBOUNCEN_DEBOUNCEN_Pos 0            /**< \brief (EIC_DEBOUNCEN) Debouncer Enable */
#define EIC_DEBOUNCEN_DEBOUNCEN_Msk (_U(0xFFFF) << EIC_DEBOUNCEN_DEBOUNCEN_Pos)
#define EIC_DEBOUNCEN_DEBOUNCEN(value) (EIC_DEBOUNCEN_DEBOUNCEN_Msk & ((value) << EIC_DEBOUNCEN_DEBOUNCEN_Pos))
#define EIC_DEBOUNCEN_MASK          _U(0x0000FFFF) /**< \brief (EIC_DEBOUNCEN) MASK Register */
...
#define EIC_DPRESCALER_RESETVALUE   _U(0x00000000) /**< \brief (EIC_DPRESCALER reset_value) Debouncer Prescaler */

#define EIC_DPRESCALER_PRESCALER0_Pos 0            /**< \brief (EIC_DPRESCALER) Debouncer Prescaler */
#define EIC_DPRESCALER_PRESCALER0_Msk (_U(0x7) << EIC_DPRESCALER_PRESCALER0_Pos)
...
#define EIC_DPRESCALER_STATES0      (_U(0x1) << EIC_DPRESCALER_STATES0_Pos)
#define EIC_DPRESCALER_PRESCALER1_Pos 4            /**< \brief (EIC_DPRESCALER) Debouncer Prescaler */
#define EIC_DPRESCALER_PRESCALER1_Msk (_U(0x7) << EIC_DPRESCALER_PRESCALER1_Pos)
...
#define EIC_DPRESCALER_STATES1      (_U(0x1) << EIC_DPRESCALER_STATES1_Pos)
#define EIC_DPRESCALER_TICKON_Pos   16           /**< \brief (EIC_DPRESCALER) Pin Sampler frequency selection */
#define EIC_DPRESCALER_TICKON       (_U(0x1) << EIC_DPRESCALER_TICKON_Pos)
#define EIC_DPRESCALER_MASK         _U(0x000100FF) /**< \brief (EIC_DPRESCALER) MASK Register */
...
#define EIC_PINSTATE_RESETVALUE     _U(0x00000000) /**< \brief (EIC_PINSTATE reset_value) Pin State */

#define EIC_PINSTATE_PINSTATE_Pos   0            /**< \brief (EIC_PINSTATE) Pin State */
#define EIC_PINSTATE_PINSTATE_Msk   (_U(0xFFFF) << EIC_PINSTATE_PINSTATE_Pos)
#define EIC_PINSTATE_PINSTATE(value) (EIC_PINSTATE_PINSTATE_Msk & ((value) << EIC_PINSTATE_PINSTATE_Pos))
#define EIC_PINSTATE_MASK           _U(0x0000FFFF) /**< \brief (EIC_PINSTATE) MASK Register */
