...
#define   PORT_EVCTRL_EVACT0_OUT_Val      _U(0x0)   /**< \brief (PORT_EVCTRL) Event output to pin */
#define   PORT_EVCTRL_EVACT0_SET_Val      _U(0x1)   /**< \brief (PORT_EVCTRL) Set output register of pin on event */
#define   PORT_EVCTRL_EVACT0_CLR_Val      _U(0x2)   /**< \brief (PORT_EVCTRL) Clear output register of pin on event */
#define   PORT_EVCTRL_EVACT0_TGL_Val      _U(0x3)   /**< \brief (PORT_EVCTRL) Toggle output register of pin on event */
...
#define PORT_PMUX_RESETVALUE        _U(0x00)     /**< \brief (PORT_PMUX reset_value) Peripheral Multiplexing */
...
#define PORT_PINCFG_RESETVALUE      _U(0x00)     /**< \brief (PORT_PINCFG reset_value) Pin Configuration */
