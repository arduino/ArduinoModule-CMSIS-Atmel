...
#define   AC_COMPCTRL_HYST_HYST100_Val    _U(0x1)   /**< \brief (AC_COMPCTRL) 100mV */
#define   AC_COMPCTRL_HYST_HYST150_Val    _U(0x2)   /**< \brief (AC_COMPCTRL) 150mV */
...
#define AC_CALIB_RESETVALUE         _U(0x0101)   /**< \brief (AC_CALIB reset_value) Calibration */

#define AC_CALIB_BIAS0_Pos          0            /**< \brief (AC_CALIB) COMP0/1 Bias Scaling */
#define AC_CALIB_BIAS0_Msk          (_U(0x3) << AC_CALIB_BIAS0_Pos)
#define AC_CALIB_BIAS0(value)       (AC_CALIB_BIAS0_Msk & ((value) << AC_CALIB_BIAS0_Pos))
#define AC_CALIB_MASK               _U(0x0003)   /**< \brief (AC_CALIB) MASK Register */
