...
#define SUPC_INTENCLR_MASK          _U(0x0000053F) /**< \brief (SUPC_INTENCLR) MASK Register */
...
#define SUPC_INTENSET_MASK          _U(0x0000053F) /**< \brief (SUPC_INTENSET) MASK Register */
...
#define SUPC_INTFLAG_MASK           _U(0x0000053F) /**< \brief (SUPC_INTFLAG) MASK Register */
...
#define SUPC_STATUS_MASK            _U(0x0000053F) /**< \brief (SUPC_STATUS) MASK Register */
...
#define   SUPC_BOD33_ACTION_BKUP_Val      _U(0x3)   /**< \brief (SUPC_BOD33) The BOD33 puts the device in backup sleep mode */
...
#define SUPC_BOD33_RUNHIB           (_U(0x1) << SUPC_BOD33_RUNHIB_Pos)
...
#define SUPC_BOD33_HYST_Msk         (_U(0xF) << SUPC_BOD33_HYST_Pos)
...
#define SUPC_BOD33_PSEL_Msk         (_U(0x7) << SUPC_BOD33_PSEL_Pos)
#define SUPC_BOD33_PSEL(value)      (SUPC_BOD33_PSEL_Msk & ((value) << SUPC_BOD33_PSEL_Pos))
#define   SUPC_BOD33_PSEL_NODIV_Val       _U(0x0)   /**< \brief (SUPC_BOD33) Not divided */
...
#define SUPC_BOD33_LEVEL_Msk        (_U(0xFF) << SUPC_BOD33_LEVEL_Pos)
...
#define SUPC_BOD33_VBATLEVEL_Msk    (_U(0xFF) << SUPC_BOD33_VBATLEVEL_Pos)
#define SUPC_BOD33_VBATLEVEL(value) (SUPC_BOD33_VBATLEVEL_Msk & ((value) << SUPC_BOD33_VBATLEVEL_Pos))
#define SUPC_BOD33_MASK             _U(0xFFFF7FFE) /**< \brief (SUPC_BOD33) MASK Register */
...
#define SUPC_VREG_RESETVALUE        _U(0x00000002) /**< \brief (SUPC_VREG reset_value) VREG Control */
...
#define SUPC_VREG_SEL               (_U(0x1) << SUPC_VREG_SEL_Pos)
...
#define SUPC_VREG_RUNBKUP           (_U(0x1) << SUPC_VREG_RUNBKUP_Pos)
#define SUPC_VREG_VSEN_Pos          16           /**< \brief (SUPC_VREG) Voltage Scaling Enable */
#define SUPC_VREG_VSEN              (_U(0x1) << SUPC_VREG_VSEN_Pos)
#define SUPC_VREG_VSPER_Pos         24           /**< \brief (SUPC_VREG) Voltage Scaling Period */
#define SUPC_VREG_VSPER_Msk         (_U(0x7) << SUPC_VREG_VSPER_Pos)
#define SUPC_VREG_VSPER(value)      (SUPC_VREG_VSPER_Msk & ((value) << SUPC_VREG_VSPER_Pos))
#define SUPC_VREG_MASK              _U(0x07010086) /**< \brief (SUPC_VREG) MASK Register */
...
#define SUPC_VREF_TSSEL             (_U(0x1) << SUPC_VREF_TSSEL_Pos)
...
#define SUPC_VREF_MASK              _U(0x000F00CE) /**< \brief (SUPC_VREF) MASK Register */
...
#define SUPC_BBPS_CONF              (_U(0x1) << SUPC_BBPS_CONF_Pos)
#define   SUPC_BBPS_CONF_BOD33_Val        _U(0x0)   /**< \brief (SUPC_BBPS) The power switch is handled by the BOD33 */
#define   SUPC_BBPS_CONF_FORCED_Val       _U(0x1)   /**< \brief (SUPC_BBPS) In Backup Domain, the backup domain is always supplied by battery backup power */
...
#define SUPC_BBPS_MASK              _U(0x00000005) /**< \brief (SUPC_BBPS) MASK Register */
