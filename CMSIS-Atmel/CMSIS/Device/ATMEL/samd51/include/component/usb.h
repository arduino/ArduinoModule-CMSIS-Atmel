...
#define   USB_DEVICE_STATUS_SPEED_LS_Val  _U(0x1)   /**< \brief (USB_DEVICE_STATUS) Low-speed mode */
#define   USB_DEVICE_STATUS_SPEED_HS_Val  _U(0x2)   /**< \brief (USB_DEVICE_STATUS) High-speed mode */
