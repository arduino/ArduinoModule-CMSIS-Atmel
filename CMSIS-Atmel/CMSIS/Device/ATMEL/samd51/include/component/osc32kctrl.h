...
#define OSC32KCTRL_INTENCLR_XOSC32KFAIL (_U(0x1) << OSC32KCTRL_INTENCLR_XOSC32KFAIL_Pos)
#define OSC32KCTRL_INTENCLR_MASK    _U(0x00000005) /**< \brief (OSC32KCTRL_INTENCLR) MASK Register */
...
#define OSC32KCTRL_INTENSET_XOSC32KFAIL (_U(0x1) << OSC32KCTRL_INTENSET_XOSC32KFAIL_Pos)
#define OSC32KCTRL_INTENSET_MASK    _U(0x00000005) /**< \brief (OSC32KCTRL_INTENSET) MASK Register */
...
#define OSC32KCTRL_INTFLAG_XOSC32KFAIL (_U(0x1) << OSC32KCTRL_INTFLAG_XOSC32KFAIL_Pos)
#define OSC32KCTRL_INTFLAG_MASK     _U(0x00000005) /**< \brief (OSC32KCTRL_INTFLAG) MASK Register */
...
#define OSC32KCTRL_STATUS_XOSC32KFAIL (_U(0x1) << OSC32KCTRL_STATUS_XOSC32KFAIL_Pos)
#define OSC32KCTRL_STATUS_XOSC32KSW_Pos 3            /**< \brief (OSC32KCTRL_STATUS) XOSC32K Clock switch */
#define OSC32KCTRL_STATUS_XOSC32KSW (_U(0x1) << OSC32KCTRL_STATUS_XOSC32KSW_Pos)
#define OSC32KCTRL_STATUS_MASK      _U(0x0000000D) /**< \brief (OSC32KCTRL_STATUS) MASK Register */
...
#define OSC32KCTRL_RTCCTRL_RESETVALUE _U(0x00)     /**< \brief (OSC32KCTRL_RTCCTRL reset_value) RTC Clock Selection */
...
#define OSC32KCTRL_RTCCTRL_MASK     _U(0x07)     /**< \brief (OSC32KCTRL_RTCCTRL) MASK Register */
...
#define OSC32KCTRL_XOSC32K_RESETVALUE _U(0x2080)   /**< \brief (OSC32KCTRL_XOSC32K reset_value) 32kHz External Crystal Oscillator (XOSC32K) Control */
...
#define OSC32KCTRL_XOSC32K_CGM_Msk  (_U(0x3) << OSC32KCTRL_XOSC32K_CGM_Pos)
#define OSC32KCTRL_XOSC32K_CGM(value) (OSC32KCTRL_XOSC32K_CGM_Msk & ((value) << OSC32KCTRL_XOSC32K_CGM_Pos))
#define   OSC32KCTRL_XOSC32K_CGM_XT_Val   _U(0x1)   /**< \brief (OSC32KCTRL_XOSC32K) Standard mode */
#define   OSC32KCTRL_XOSC32K_CGM_HS_Val   _U(0x2)   /**< \brief (OSC32KCTRL_XOSC32K) High Speed mode */
...
#define OSC32KCTRL_XOSC32K_MASK     _U(0x77DE)   /**< \brief (OSC32KCTRL_XOSC32K) MASK Register */
...
#define OSC32KCTRL_CFDCTRL_RESETVALUE _U(0x00)     /**< \brief (OSC32KCTRL_CFDCTRL reset_value) Clock Failure Detector Control */

#define OSC32KCTRL_CFDCTRL_CFDEN_Pos 0            /**< \brief (OSC32KCTRL_CFDCTRL) Clock Failure Detector Enable */
#define OSC32KCTRL_CFDCTRL_CFDEN    (_U(0x1) << OSC32KCTRL_CFDCTRL_CFDEN_Pos)
#define OSC32KCTRL_CFDCTRL_SWBACK_Pos 1            /**< \brief (OSC32KCTRL_CFDCTRL) Clock Switch Back */
#define OSC32KCTRL_CFDCTRL_SWBACK   (_U(0x1) << OSC32KCTRL_CFDCTRL_SWBACK_Pos)
#define OSC32KCTRL_CFDCTRL_CFDPRESC_Pos 2            /**< \brief (OSC32KCTRL_CFDCTRL) Clock Failure Detector Prescaler */
#define OSC32KCTRL_CFDCTRL_CFDPRESC (_U(0x1) << OSC32KCTRL_CFDCTRL_CFDPRESC_Pos)
#define OSC32KCTRL_CFDCTRL_MASK     _U(0x07)     /**< \brief (OSC32KCTRL_CFDCTRL) MASK Register */
...
#define OSC32KCTRL_EVCTRL_RESETVALUE _U(0x00)     /**< \brief (OSC32KCTRL_EVCTRL reset_value) Event Control */

#define OSC32KCTRL_EVCTRL_CFDEO_Pos 0            /**< \brief (OSC32KCTRL_EVCTRL) Clock Failure Detector Event Output Enable */
#define OSC32KCTRL_EVCTRL_CFDEO     (_U(0x1) << OSC32KCTRL_EVCTRL_CFDEO_Pos)
#define OSC32KCTRL_EVCTRL_MASK      _U(0x01)     /**< \brief (OSC32KCTRL_EVCTRL) MASK Register */
...
#define OSC32KCTRL_OSCULP32K_RESETVALUE _U(0x00000000) /**< \brief (OSC32KCTRL_OSCULP32K reset_value) 32kHz Ultra Low Power Internal Oscillator (OSCULP32K) Control */

#define OSC32KCTRL_OSCULP32K_EN32K_Pos 1            /**< \brief (OSC32KCTRL_OSCULP32K) Enable Out 32k */
#define OSC32KCTRL_OSCULP32K_EN32K  (_U(0x1) << OSC32KCTRL_OSCULP32K_EN32K_Pos)
#define OSC32KCTRL_OSCULP32K_EN1K_Pos 2            /**< \brief (OSC32KCTRL_OSCULP32K) Enable Out 1k */
#define OSC32KCTRL_OSCULP32K_EN1K   (_U(0x1) << OSC32KCTRL_OSCULP32K_EN1K_Pos)
#define OSC32KCTRL_OSCULP32K_CALIB_Pos 8            /**< \brief (OSC32KCTRL_OSCULP32K) Oscillator Calibration */
#define OSC32KCTRL_OSCULP32K_CALIB_Msk (_U(0x3F) << OSC32KCTRL_OSCULP32K_CALIB_Pos)
...
#define OSC32KCTRL_OSCULP32K_MASK   _U(0x0000BF06) /**< \brief (OSC32KCTRL_OSCULP32K) MASK Register */
